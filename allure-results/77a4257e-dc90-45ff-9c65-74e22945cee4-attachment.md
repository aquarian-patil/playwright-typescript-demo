...
- Name: api\dummyjson.spec.ts >> DummyJSON API Tests >> Authentication >> should fail login with invalid credentials
- Location: tests\api\dummyjson.spec.ts:47:9
...
```ts
  ...
  2   | import { DummyJsonClient } from '../../src/api/clients/DummyJsonClient';
  3   | import { EnvironmentManager } from '../../src/config/EnvironmentManager';
  4   | 
  5   | /**
  6   |  * DummyJSON API Test Suite
  7   |  * 
  8   |  * Tests the DummyJSON API (https://dummyjson.com)
  9   |  * - FREE API (no API key required)
  10  |  * - Perfect for CI/CD (no secrets needed)
